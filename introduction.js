...
// JavaScript is the programming language of the Webdevelopment"

//  JavaScript is a cross-platform, object-oriented scripting language used to make webpages
//   interactive (e.g., having complex animations, clickable buttons, popup menus, etc.).
//   There are also more advanced server side versions of JavaScript such as Node.js, 
//   which allow you to add more functionality to a website than downloading 
